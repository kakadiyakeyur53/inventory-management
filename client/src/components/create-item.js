...
export default class UpdateList extends Component {
    ...
    render() {
        ...
        return (
            <div className="container mx-auto" style={{maxWidth:"80%",marginTop:"60px"}}>
                <h3>Create Items</h3>
                <form onSubmit={this.onSubmit}>
                    <div className="form-group">
                        <div className="row">
                        <label className="col-sm-12 col-md-2" style={{paddingLeft:"0px"}}>Item Name : </label>
                        <input type="text"
                    ...
                    <div className="form-group">
                    <div className="row">
                        <label className="col-sm-12 col-md-2" style={{paddingLeft:"0px"}}>Quantity : </label>
                        <input type="number"
                        className="form-control col-sm-12 col-md-10"
